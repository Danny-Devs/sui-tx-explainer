    ...
    >
      ...
      <div class="p-4 space-y-3 text-sm">
        ...
        <template v-else-if="nodeType === 'object'">
          <div>
            <div class="text-gray-400 text-xs mb-1">Object Type</div>
            <code class="text-xs bg-gray-800 px-2 py-1 rounded block truncate">
              {{ nodeObjectType || nodeLabel }}
            </code>
          </div>
          <div v-if="nodeObjectId">
            <div class="text-gray-400 text-xs mb-1">Object ID</div>
            <div class="flex items-center gap-2">
              <code class="text-xs bg-gray-800 px-2 py-1 rounded flex-1 truncate">
                {{ nodeObjectId }}
              </code>
        ...
        <template v-else-if="nodeType === 'gas'">
          ...
          <div class="text-gray-400 text-xs">
            Gas fees pay for computation and storage on the Sui network.
          </div>
        </template>
